...
const TaskCard = ({task, index, handleTaskChanged}) => {
    ...
    const deleteTask = async (taskId)=>{
        try {
            ...
            toast.error("Xóa nhiệm vụ thất bại. Vui lòng thử lại.");
        }
    }
    ...
    const toggleTaskCompleteButton = async () => {
        try {
            ...
            toast.error("Cập nhật nhiệm vụ thất bại. Vui lòng thử lại.");
        }
    }
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="hidden gap-2 group-hover:inline-flex animate-slide-up">
                    ...
                    <Button
                     variant="ghost"
                     size="icon"
                     className="flex-shrink-0 transition-colors size-8 text-muted-forground hover:text-info"
                     onClick ={()=>{
                        setIsEditing(true);
                        setUpdateTaskTitle(task.title || "");
                     }}
